		...
		if(($cart != null) && ($errorcode == 0)) {
			...
			//	do_action('wpsc_confirm_checkout', $purchase_log['id']);
			  ...
			  $total_shipping += $purchase_log['base_shipping'];
				...
				$total_shipping_html.= "<tr><td colspan='4' style='text-align:right'>".__('Total Shipping', 'wpsc').": </td><td><span id='checkout_shipping' class='pricedisplay3'>".substr(nzshpcrt_currency_display($total_shipping,1,true),2)."</span></td></tr>";
				$total_price_html.= "<tr><td colspan='4' style='text-align:right'>".__('Total', 'wpsc').": </td><td><span id='checkout_shipping' class='pricedisplay3'>".substr(nzshpcrt_currency_display($total, 1,true),2)."</span></td></tr>";
				if(isset($_GET['ti'])) {
