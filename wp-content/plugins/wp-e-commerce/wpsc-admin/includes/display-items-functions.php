...
?>
			<tr>
				<td colspan='2'>
                	<input type='checkbox' name='custom_units' id='custom_units' class='text' onchange='enable_units()' <?php echo ($product_data[custom_units] != 0) ? "checked='checked'" : "";?> />Enable Custom Units<br />
                </td>
			</tr>
            <tr>
            	<td>
					<div id='applicable_units' class='postbox'>
					<h3 class='hndle'>Custom Units</h3>
                    <table>
                    	<tr>
                        	<td width='100px'>
                				<input type='checkbox' name='units_grams' id='units_grams' class='text' onchange="enable_minimum_value('grams')" <?php echo ($product_data['custom_units'] != 0) ? '' : "disabled='disabled'"; ?> <?php echo ($product_data['units_grams']) ? "checked='checked'" : '';?> />Grams
                            </td>
                            <td width='150px'>
                                Minimum value <input type='text' name='min_grams' id='min_grams' class='text' <?php echo ($product_data['units_grams'] != 0) ? '' : "disabled='disabled'"; ?> value='<?php echo ($product_data['min_grams'] || $product_data['min_grams'] == 0) ? htmlentities(stripslashes($product_data['min_grams']), ENT_QUOTES, 'UTF-8') : '100'; ?>' />
                            </td>
                            <td>
                            	Maximum value <input type='text' name='max_grams' id='max_grams' class='text' <?php echo ($product_data['units_grams'] != 0) ? '' : "disabled='disabled'"; ?>  value='<?php echo ($product_data['max_grams'] || $product_data['max_grams'] == 0) ? htmlentities(stripslashes($product_data['max_grams']), ENT_QUOTES, 'UTF-8') : '200'; ?>' />
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type='checkbox' name='units_kilograms' id='units_kilograms' class='text' onchange="enable_minimum_value('kilograms')" <?php echo ($product_data['custom_units'] != 0) ? '' : "disabled='disabled'"; ?> <?php echo ($product_data['units_kilograms']) ? "checked='checked'" : '';?> />Kilograms
                            </td>
                            <td>
                                Minimum value <input type='text' name='min_kilograms' id='min_kilograms' class='text' <?php echo ($product_data['units_kilograms'] != 0) ? '' : "disabled='disabled'"; ?> value='<?php echo ($product_data['min_kilograms'] || $product_data['min_kilograms'] == 0) ? htmlentities(stripslashes($product_data['min_kilograms']), ENT_QUOTES, 'UTF-8') : '100'; ?>' />
                            </td>
                            <td>
                            	Maximum value <input type='text' name='max_kilograms' id='max_kilograms' class='text' <?php echo ($product_data['units_kilograms'] != 0) ? '' : "disabled='disabled'"; ?>  value='<?php echo ($product_data['max_kilograms'] || $product_data['max_kilograms'] == 0) ? htmlentities(stripslashes($product_data['max_kilograms']), ENT_QUOTES, 'UTF-8') : '200'; ?>' />
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type='checkbox' name='units_ounces' id='units_ounces' class='text' onchange="enable_minimum_value('ounces')" <?php echo ($product_data['custom_units'] != 0) ? '' : "disabled='disabled'"; ?> <?php echo ($product_data['units_ounces']) ? "checked='checked'" : '';?> />Ounces
                            </td>
                            <td>
                                Minimum value <input type='text' name='min_ounces' id='min_ounces' class='text' <?php echo ($product_data['units_ounces'] != 0) ? '' : "disabled='disabled'"; ?> value='<?php echo ($product_data['min_ounces'] || $product_data['min_ounces'] == 0) ? htmlentities(stripslashes($product_data['min_ounces']), ENT_QUOTES, 'UTF-8') : '100'; ?>' />
                            </td>
                            <td>
                            	Maximum value <input type='text' name='max_ounces' id='max_ounces' class='text' <?php echo ($product_data['units_ounces'] != 0) ? '' : "disabled='disabled'"; ?> value='<?php echo ($product_data['max_ounces'] || $product_data['max_ounces'] == 0) ? htmlentities(stripslashes($product_data['max_ounces']), ENT_QUOTES, 'UTF-8') : '200'; ?>' />
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type='checkbox' name='units_pounds' id='units_pounds' class='text' onchange="enable_minimum_value('pounds')" <?php echo ($product_data['custom_units'] != 0) ? '' : "disabled='disabled'"; ?> <?php echo ($product_data['units_pounds']) ? "checked='checked'" : '';?> />Pounds
                            </td>
                            <td>
                                Minimum value <input type='text' name='min_pounds' id='min_pounds' class='text' <?php echo ($product_data['units_pounds'] != 0) ? '' : "disabled='disabled'"; ?> value='<?php echo ($product_data['min_pounds'] || $product_data['min_pounds'] == 0) ? htmlentities(stripslashes($product_data['min_pounds']), ENT_QUOTES, 'UTF-8') : '100'; ?>' />
                            </td>
                            <td>
                            	Maximum value <input type='text' name='max_pounds' id='max_pounds' class='text' <?php echo ($product_data['units_pounds'] != 0) ? '' : "disabled='disabled'"; ?> value='<?php echo ($product_data['max_pounds'] || $product_data['max_pounds'] == 0) ? htmlentities(stripslashes($product_data['max_pounds']), ENT_QUOTES, 'UTF-8') : '200'; ?>' />
                            </td>
                        </tr>
					</table>
                    </div>
...
<?php //echo "<script>alert('wpsc_product_variation_forms()')</script>"; ?>
