...
*/	
	...
	$receipt_list = "<table style='background:#fff;width:500px!important;border-collapse:collapse;border-spacing:0;font-family: Arial, sans-serif;'>
						        	<tr>
						            	<td style='color:#000;font-size:14px;font-weight:bold;border:1px solid #888;text-align:left;padding:2px;width:20px;height:20px;'>&nbsp;</td>
   										<td style='color:#000;font-size:14px;font-weight:bold;border:1px solid #888;text-align:left;padding:2px;width:290px;height:20px;'>Product</td>
   										<td style='color:#000;font-size:14px;font-weight:bold;border:1px solid #888;text-align:left;padding:2px;width:70px;height:20px;'>Quantity</td>
   										<td style='color:#000;font-size:14px;font-weight:bold;border:1px solid #888;text-align:left;padding:2px;width:80px;height:20px;'>Unit Price</td>
										<td style='color:#000;font-size:14px;font-weight:bold;border:1px solid #888;text-align:left;padding:2px;width:80px;height:20px;'>Total</td>
									</tr>";
			...
			//	do_action('wpsc_confirm_checkout', $purchase_log['id']);
				...
				if($link != '' && (!empty($link))) {
				  $additional_content = apply_filters('wpsc_transaction_result_content', array("purchase_id" =>$purchase_log['id'], "cart_item"=>$row, "purchase_log"=>$purchase_log));
					...
					$receipt_list .= "<tr><td style='color:#888;font-size:12px;font-weight:bold;line-height:18px;padding:4px;vertical-align:middle;border: 1px solid #AAA;background: white;text-align:right;'>"
													.($i+1)
													."</td><td style='color:#888;font-size:12px;font-weight:bold;line-height:18px;padding:4px;vertical-align:middle;border: 1px solid #AAA;background: white;text-align:left;'>"
													.$name[0]
			  ...
			  $total_shipping += $purchase_log['base_shipping'];
				...
				$total_shipping_receipt = "<tr><td colspan='4' style='color:#888;font-size:12px;font-weight:bold;line-height:18px;padding:4px;vertical-align:middle;border: 1px solid #AAA;background:white;text-align:right;'>Total Shipping</td>"
												."<td style='width:140px;color:#181818;font-size:11px;border: 1px solid #AAA;font-weight:bold;'>".trim(substr(nzshpcrt_currency_display($total_shipping,1,true),2))."</td></tr>";
				$total_price_email.= __('Total', 'wpsc').": ".trim(substr(nzshpcrt_currency_display($total,1,true),2))."\n\r";
				$total_price_receipt = "<tr><td colspan='4' style='color:#888;font-size:12px;font-weight:bold;line-height:18px;padding:4px;vertical-align:middle;border: 1px solid #AAA;background:white;text-align:right;'>Total</td>"
												."<td style='width:140px;color:#181818;font-size:11px;border: 1px solid #AAA;font-weight:bold;'>".trim(substr(nzshpcrt_currency_display($total,1,true),2))."</td></tr></table>";
