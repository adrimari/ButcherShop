...
function transaction_results($sessionid, $echo_to_screen = true, $transaction_id = null) {
	...
	$receipt_list = "<table style='background:#fff;width:500px!important;border-collapse:collapse;border-spacing:0;font-family: Arial, sans-serif;'>
						        	<tr>
						            	<td style='color:#000;font-size:14px;font-weight:bold;border:1px solid #888;text-align:left;padding:2px;width:20px;'>&nbsp;</td>
   										<td style='color:#000;font-size:14px;font-weight:bold;border:1px solid #888;text-align:left;padding:2px;width:290px;'>Product</td>
   										<td style='color:#000;font-size:14px;font-weight:bold;border:1px solid #888;text-align:left;padding:2px;width:70px;'>Quantity</td>
   										<td style='color:#000;font-size:14px;font-weight:bold;border:1px solid #888;text-align:left;padding:2px;width:80px;'>Unit Price</td>
										<td style='color:#000;font-size:14px;font-weight:bold;border:1px solid #888;text-align:left;padding:2px;width:80px;'>Total</td>
									</tr>";
