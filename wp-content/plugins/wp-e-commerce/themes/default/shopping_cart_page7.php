...
<?php } ?>
        <tr class='total_price'>
			...
			<td>
            	<?php if (str_replace(",", "", substr(wpsc_cart_total(),3)) >= 500) {
						$total = str_replace(",", "", substr(wpsc_cart_total(),2));
					} else {
						$total = "R".number_format(str_replace(",", "", substr(wpsc_cart_total(),3)) - 100,2,".","");
					}
				?>
