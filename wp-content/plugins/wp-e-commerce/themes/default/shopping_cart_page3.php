...
<?php while (wpsc_have_cart_items()) : wpsc_the_cart_item(); 
		if (wpsc_cart_item_custom_units() == 1 && (wpsc_cart_item_units_grams() != 0 || wpsc_cart_item_units_kilograms() != 0 || wpsc_cart_item_units_ounces() != 0 || wpsc_cart_item_units_pounds() != 0))
			$custom = 1;
		else if (wpsc_cart_item_custom_units() == 0 && (wpsc_cart_item_units_grams() == '' && wpsc_cart_item_units_kilograms() == '' && wpsc_cart_item_units_ounces() == '' && wpsc_cart_item_units_pounds() == ''))
			$custom = 0;
		else $custom = -1;
?>
        	<tr>
...
<?php } ?>
        <tr class='total_price'>
			...
			<td>
				<span id='checkout_total' class="pricedisplay3 checkout-total"><?php echo str_replace(",", "", substr(wpsc_cart_total(),2)); ?></span>
			</td>
            <td style="text-align:center;">
	...
	<table class='wpsc_checkout_table'>
		...
		<tr>
			<td colspan='2' id="link">
     			 <input type='checkbox' value='yes' name='agree' /> <?php echo __('I agree to <a href="" id="link">the terms and conditions</a>', 'wpsc');?>
   		   </td>
 	   </tr>
		<?php endif; ?>	
...
<div class="shopcart_empty">
	...
	<div class="blacktext"><a class="greenlinkbig" href="<?php echo home_url( '/' )."?page_id=10"; ?>">Click here</a> to view our selection of meats...</div>
</div>
<?php 
endif;
