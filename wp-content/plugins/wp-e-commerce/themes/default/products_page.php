            ...
            <div class='wpsc_categories wpsc_category_grid' id="grid_item">
				...
				<div id="category">
					...
					<a href="<?php wpsc_print_category_url();?>" class="wpsc_category_grid_item" title='<?php wpsc_print_category_name();?>'>
						...
						<div id="view_prod"><a href="<?php wpsc_print_category_url();?>" title='<?php echo wpsc_print_category_name();?>'>view products</a><div class="arrow2"></div></div>
			...
			<div class="prod_left_col">
				<div class="product_bg">
					<div class="prod_title">
						<a href="<?php echo wpsc_the_product_permalink(); ?>" onclick="" id="anchor"><?php echo wpsc_the_product_title(); ?></a>
		...
		if($query->units_kilograms) { ?>
						<tr>
                            ...
                            <td width="20px" height="15px">
                                ...
                                onkeydown="clear1('<?php echo wpsc_the_product_id(); ?>','units_grams<?php echo wpsc_the_product_id(); ?>','total_grams<?php echo wpsc_the_product_id(); ?>', 'units_kilograms<?php echo wpsc_the_product_id(); ?>')"
...
<div class="shopcart_empty">
	<div class="title"><h4>
<?php $cat = $wpdb->get_var("SELECT `name` FROM `wp_wpsc_product_categories` WHERE id = ".wpsc_category_current_id());
				echo $cat; ?>
	</h4></div>
...
<!-- End Pagination -->
<div style="clear: both;"></div>
<?php if (wpsc_category_current_id()) { ?>
