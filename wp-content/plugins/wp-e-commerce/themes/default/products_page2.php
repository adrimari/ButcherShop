...
if ($query->custom_units == 1) { ?>
            ...
            <div style="width: 100%; height: 20px">
				...
				<label for="items<?php echo wpsc_the_product_id(); ?>" <?php echo (wpsc_have_variation_groups()) ? "onclick='enable_item('".wpsc_the_product_id()."','".wpsc_vargrp_form_id()."')'" : ""; ?> >PRE-PACKAGED</label>
			</div>	
							...
							<div class="quantity">
								...
								<div id="right">
									<input type="text" id='custom_wpsc_quantity_update<?php echo wpsc_the_product_id(); ?>' 
                                        ...
                                        value="0" <?php //echo ($wpsc_cart->get_cart_item(wpsc_the_product_id())) ? $wpsc_cart->get_cart_item(wpsc_the_product_id())->quantity : "0"; ?> 
							...
							<div class="quantity">
								...
								<div id="right">
									<input type="text" id='wpsc_quantity_update<?php echo wpsc_the_product_id(); ?>' 
                                        ...
                                        value="<?php echo "0";//($wpsc_cart->get_cart_item(wpsc_the_product_id())) ? $wpsc_cart->get_cart_item(wpsc_the_product_id())->quantity : "0"; ?>" 
                                        onblur="update_qty(<?php echo wpsc_the_product_id(); ?>)" 
                                        onkeyup="update_qty(<?php echo wpsc_the_product_id(); ?>)"/>
									<input type="hidden" name="key" value="<?php echo wpsc_the_cart_item_key(); ?>"/>
									<input type="hidden" name="wpsc_update_quantity" value="true"/>
...
<a href="#top" class="top_link" id="cart_table">[back to top]</a>
<?php } ?>