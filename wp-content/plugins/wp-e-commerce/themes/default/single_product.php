...
<?php //****************************** ?>
				...
				<?php if ($query->custom_units == 1) { ?>
                    ...
                    <?php if (isset($_GET['key'])) : ?>
                    	<div class="add_prod"><a href="<?php echo wpsc_cart_item_url()."?category=".$_GET['category']."&product_id=".$_GET['product_id']."&custom=".$_GET['custom']; ?>" title="Add new Product">[Add a new product...]</a></div><!-- .add_prod -->
                    <?php endif; ?>
                    </div>
...
<?php endif ; ?>
                        ...
                        <?php endif; ?>	
                    	<?php //if (isset($_GET['key'])) : ?>
                    		<div class="add_prod" <?php if (!isset($_GET['key'])) echo 'style="display:none;"'; ?>><a href="<?php wpsc_cart_item_url()."?category=".$_GET['category']."&product_id=".$_GET['product_id']; ?>" title="Add new Product">[Add a new product...]</a></div>
                    	<?php //endif; ?>
						<div class="prod_form">
<?php	/**/
		if (isset($_GET['key']) && $wpsc_cart->get_cart_item_by_key($_GET['key'])) { //get_cart_item(wpsc_the_product_id())) {
