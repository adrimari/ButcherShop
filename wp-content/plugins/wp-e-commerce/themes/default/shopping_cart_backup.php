...
<div class="outer_product_container">
	...
	<?php while (wpsc_have_cart_items()) : wpsc_the_cart_item(); ?>
        	<tr>
        		<td><img src='<?php echo wpsc_cart_item_image(48,48); ?>' alt='<?php echo wpsc_cart_item_name(); ?>' title='<?php echo wpsc_cart_item_name(); ?>' /></td>
        		<td><a href='<?php echo wpsc_cart_item_url()."&key=".wpsc_the_cart_item_key();?>'><?php echo wpsc_cart_item_name(); ?></a></td>
        		<td>
				...
				<?php endif; ?>
        		<td><span class="pricedisplay"><?php echo substr(wpsc_cart_item_price(),2); ?></span></td>
        		<td>
				<form action="<?php echo get_option('shopping_cart_url'); ?>" method="post" class="adjustform">
...
<table class="productcart">
	...
	<?php  //this displays the confirm your order html	?>
		...
		<tr class="product_row">
			...
			<td class="firstcol">
			<a href='<?php echo wpsc_cart_item_url()."&key=".wpsc_the_cart_item_key();?>'><?php echo wpsc_cart_item_name(); ?></a>
			</td>
			<td>
				<?php if (wpsc_cart_item_custom_units() == 1) {
						echo $wpsc_cart->cart_item->custom_weight; 
