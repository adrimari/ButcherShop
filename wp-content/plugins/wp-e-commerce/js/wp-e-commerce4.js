...
/*	function clear(item) {
	...
	function rounding(id, units, price, product_id, minimum, maximum) {
		...
		if (length >= 1)
		{
			if (length == 1) {
				...
				//alert('value[0]: ' + e.value[0]);
				//alert('value[1]: ' + e.value[1]);
				if(e.value % 10 < 5)
					e.value = e.value[0] + '0';
				else {
				...
				if(e.value % 10 < 5) {
					...
					if (e.value[0] == '9' && e.value[1] == '9')
						e.value = '990';
							...
							//alert(index0);
							var index1 = 0; //e.value[1] = '0';
							//alert(index1);
							var index2 = 0; //e.value[2] = '0';
							//alert(index2);
					...
					//}
					//e.value = e.value[0] + (e.value[1] + 1) + '0';
				}
			}
		}
		//update_qty(id);
	...
	function clear1(id, units, total) {
		//alert('stuff');
