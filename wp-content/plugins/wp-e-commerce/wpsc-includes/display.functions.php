...
function fancy_notification_content($cart_messages) {
  ...
  $siteurl = get_option('siteurl');
	...
	$output .= "<div style='float:left;'><a href='".get_option('shopping_cart_url')."' class='go_to_checkout'>".__('Go to Checkout', 'wpsc')."</a></div>";
	$output .= "<div style='float:left;color:#000;'> | </div>";
	$output .= "<div style='float:left;padding-left:5px;'><a href='#' onclick='jQuery(\"#fancy_notification\").css(\"display\", \"none\"); return false;' class='continue_shopping'>".__('Continue Shopping', 'wpsc')."</a></div>";
	return $output;
}
